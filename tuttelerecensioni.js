...
//   const searchTerm = searchInput.value.toLowerCase(); // converti il valore dell'input in lowercase per fare una ricerca case-insensitive
//   const cards = document.querySelectorAll('.cardarticolo');

//   cards.forEach(card => {
//     const title = card.querySelector('.titolocard').textContent.toLowerCase(); // seleziona il titolo dell'articolo dalla card e convertilo in lowercase
//     if (title.includes(searchTerm)) { // se il titolo dell'articolo include la stringa cercata, mostra la card
//       card.style.display = 'block';
//     } else { // altrimenti, nascondi la card
